...
class Session(object):
    ...
    def get_file_content(self):
        ...
        md格式： 1732763168_8a6d06e8360a48abbe0ee6c9937c975e
        '''
        zhipu_ai_api_key = conf().get("zhipu_ai_api_key")
        client = ZhipuAI(api_key=zhipu_ai_api_key)
        file_content = json.loads(client.files.content(file_id='1732763168_8a6d06e8360a48abbe0ee6c9937c975e').content)["content"]
        return file_content
